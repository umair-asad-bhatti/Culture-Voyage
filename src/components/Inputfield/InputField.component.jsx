...
export default function InputField({ type, value = '', setValue, children, maxLength, placeholder = '' }) {
  ...
  return (
    <div className={`flex items-center gap-2 bg-transparent w-full py-1 px-4 text-lg  border-2 border-borderPrimary dark:border-borderSecondary dark:focus-within:border-accent focus-within:border-blAccent  rounded-lg ${isTextarea ? 'flex-col' : ''}`}>
