            ...
            <div className='p-4   bg-primary dark:bg-darkCardBg rounded-xl shadow-lg'>
                ...
                <div className="carousel w-full">
                    {
                        postDetail['Media URL'] && postDetail['Media URL'].map((url, index) => {
                            return <div id={`item${index + 1}`} key={index} className="carousel-item w-1/2 h-60 m-2 rounded-xl shadow  p-2 bg-gray-200 dark:bg-gray-700 ">
                ...
                <div className='flex items-center justify-around  my-2   bg-slate-100 dark:bg-gray-800 rounded-xl p-2'>
                    <div className='flex items-center justify-center gap-2'>
                        <Heart aria-disabled={isLiking} onClick={() => likeOrDislikePost(postDetail.id)} size="20" variant={isLiked ? 'Bold' : 'Outline'} className="text-[#E1306C]" />
