            ...
            <div className='border p-4 shadow bg-primary dark:bg-transparent rounded-xl'>
                ...
                <div className='flex items-center justify-center gap-8 my-2   bg-slate-100 dark:bg-gray-800 rounded-xl p-2'>
                    <div className='flex items-center justify-center gap-2'>
                        ...
                        <h1>{postDetail && postDetail['Likes'].length} </h1>
                    </div>
                    <div className='flex items-center justify-center gap-2'>
                ...
                {postDetail['Created By'] == user.uid && <h1 aria-disabled={deleting} onClick={() => deletePost(postDetail.id, communityId, postType)} className="text-warning text-center p-2 border rounded-xl my-4  text-sm cursor-pointer">
