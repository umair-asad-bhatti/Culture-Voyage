...
export default function CommunityCardSkelton() {
    return (
        <div
            className={
                "border border-borderPrimary dark:border-borderSecondary shadow-sm shadow-accent  hover:bg-softGrey dark:hover:bg-darkerGrey cursor-pointer md:w-[50%] w-full h-[250px]  p-8 rounded-lg"
            }
        >
