...
export const CommunityPage = () => {
  ...
  return (
    <div className={'w-full h-full'}>
      {/* <CreateCommunity /> */}
      <p className="py-2 text-center font-bold text-lg dark:text-primary w-full ">Created communities</p>
      <CommunityListing communities={userCreatedCommunities} isFetching={isFetchingUserCreatedCommunities} />
      <p className="py-2 text-center font-bold text-lg dark:text-primary my-4">Explore Communities</p>
